...
const mockGetTotalUnreadCount = getTotalUnreadCount as jest.MockedFunction<
  typeof getTotalUnreadCount
>;
const mockGetUnreadCount =
  unifiedNotificationTracker.getUnreadCount as jest.MockedFunction<
    typeof unifiedNotificationTracker.getUnreadCount
  >;
const mockIncrementCount =
  unifiedNotificationTracker.incrementCount as jest.MockedFunction<
    typeof unifiedNotificationTracker.incrementCount
  >;
const mockDecrementCount =
  unifiedNotificationTracker.decrementCount as jest.MockedFunction<
    typeof unifiedNotificationTracker.decrementCount
  >;
const mockSetCount = unifiedNotificationTracker.setCount as jest.MockedFunction<
  typeof unifiedNotificationTracker.setCount
>;
const mockClearNotifications =
  unifiedNotificationTracker.clearNotifications as jest.MockedFunction<
    typeof unifiedNotificationTracker.clearNotifications
  >;
const mockClearAllNotifications =
  unifiedNotificationTracker.clearAllNotifications as jest.MockedFunction<
    typeof unifiedNotificationTracker.clearAllNotifications
  >;
