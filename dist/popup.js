 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ye={attribute:!0,type:String,converter:Z,reflect:!1,hasChanged:re},Ze=(e=Ye,t,s)=>{const{kind:i,metadata:o}=s;let r=globalThis.litPropertyMetadata.get(o);if(r===void 0&&globalThis.litPropertyMetadata.set(o,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(s.name,e),i==="accessor"){const{name:n}=s;return{set(c){const d=t.get.call(this);t.set.call(this,c),this.requestUpdate(n,d,e)},init(c){return c!==void 0&&this.C(n,void 0,e,c),c}}}if(i==="setter"){const{name:n}=s;return function(c){const d=this[n];t.call(this,c),this.requestUpdate(n,d,e)}}throw Error("Unsupported decorator location: "+i)};function S(e){return(t,s)=>typeof s=="object"?Ze(e,t,s):((i,o,r)=>{const n=o.hasOwnProperty(r);return o.constructor.createProperty(r,i),n?Object.getOwnPropertyDescriptor(o,r):void 0})(e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function l(e){return S({...e,state:!0,attribute:!1})}var Je=Object.defineProperty,Xe=Object.getOwnPropertyDescriptor,G=(e,t,s,i)=>{for(var o=i>1?void 0:i?Xe(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&Je(t,s,o),o};let L=class extends v{constructor(){super(...arguments),this.token="",this.isVerifying=!1,this.errorMessage="",this.isSuccess=!1}render(){return this.isSuccess?a`
        <div class="container">
  ...
  `;te([S({type:Boolean})],N.prototype,"loading",2);te([l()],N.prototype,"mirrors",2);te([l()],N.prototype,"error",2);N=te([P("pb-mirror-list")],N);var nt=Object.defineProperty,at=Object.getOwnPropertyDescriptor,K=(e,t,s,i)=>{for(var o=i>1?void 0:i?at(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(o=(i?n(t,s,o):n(o))||o);return i&&o&&nt(t,s,o),o};let I=class extends v{constructor(){super(...arguments),this.dragOver=!1,this.uploadState={file:null,uploading:!1,progress:0,error:null},this.maxFileSize=25*1024*1024}render(){return a`
      <div
  ...
  `;$([S({type:Array})],x.prototype,"subscriptions",2);$([l()],x.prototype,"searchQuery",2);$([l()],x.prototype,"searchResults",2);$([l()],x.prototype,"isLoading",2);$([l()],x.prototype,"isSearching",2);$([l()],x.prototype,"errorMessage",2);$([l()],x.prototype,"successMessage",2);$([l()],x.prototype,"activeSubtab",2);$([l()],x.prototype,"subscriptionPosts",2);$([l()],x.prototype,"isLoadingPosts",2);x=$([P("pb-channels")],x);console.log("Pushbridge popup loaded");document.addEventListener("DOMContentLoaded",async()=>{console.log("🪟 [Popup] Popup opened, sending POPUP_OPEN message");try{await chrome.runtime.sendMessage({cmd:"POPUP_OPEN"}),console.log("🪟 [Popup] POPUP_OPEN message sent successfully")}catch(t){console.error("🪟 [Popup] Failed to send POPUP_OPEN message:",t)}const e=document.querySelector(".container");if(!e){console.error("Container element not found");return}try{if(!await Me("pb_token"))e.innerHTML="<pb-token-setup></pb-token-setup>";else{const s=await Ce(),i=s?await ve():null;e.innerHTML=`
      ...
      `,gt(),s&&ft(),bt()}}catch(t){console.error("Failed to initialize popup:",t),e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#close-about");t&&t.addEventListener("click",()=>{document.body.removeChild(e)}),e.addEventListener("click",s=>{s.target===e&&document.body.removeChild(e)})}const ke=document.createElement("style");ke.textContent=`
