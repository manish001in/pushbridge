import { g as Me, v as Ce, k as ve } from './notificationBadge.js';
/**
 * @license
...
const ze = e => new ye(typeof e == 'string' ? e : e + '', void 0, oe),
  T = (e, ...t) => {
    const s =
      e.length === 1
        ? e[0]
    ...
    return new ye(s, e, oe);
  },
  Te = (e, t) => {
    if (ie)
      e.adoptedStyleSheets = t.map(s =>
 ...
 */ const {
  ...
  X = globalThis,
  pe = X.trustedTypes,
  Re = pe ? pe.emptyScript : '',
  De = X.reactiveElementPolyfillSupport,
  j = (e, t) => e,
  Z = {
    toAttribute(e, t) {
      switch (t) {
...
let R = class extends HTMLElement {
  ...
  static createProperty(t, s = he) {
    if (
      ...
      const i = Symbol(),
        o = this.getPropertyDescriptor(t, i, s);
      o !== void 0 && Ae(this.prototype, t, o);
    }
  }
  static getPropertyDescriptor(t, s, i) {
    const { get: o, set: r } = Ee(this.prototype, t) ?? {
      get() {
        return this[s];
      },
      set(n) {
  ...
  static finalize() {
    ...
    if (
      ((this.finalized = !0), this._$Ei(), this.hasOwnProperty(j('properties')))
    ) {
    ...
    if (t !== null) {
      ...
      if (s !== void 0)
        for (const [i, o] of s) this.elementProperties.set(i, o);
    }
    this._$Eh = new Map();
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of i) s.unshift(ce(o));
  ...
  _$ET(t, s) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const r = (
        i.converter?.toAttribute !== void 0 ? i.converter : Z
        ...
        n =
          typeof r.converter == 'function'
            ...
            : r.converter?.fromAttribute !== void 0
              ...
              : Z;
      this._$Em = o;
      const c = n.fromAttribute(s, r.type);
  ...
  C(t, s, { useDefault: i, reflect: o, wrapped: r }, n) {
    (i &&
      ...
      (this._$Ej.set(t, n ?? s ?? this[t]), r !== !0 || n !== void 0)) ||
      (this._$AL.has(t) ||
...
((R.elementStyles = []),
  ...
  (R[j('elementProperties')] = new Map()),
  (R[j('finalized')] = new Map()),
  De?.({ ReactiveElement: R }),
 ...
 */ const ne = globalThis,
  J = ne.trustedTypes,
  ue = J ? J.createPolicy('lit-html', { createHTML: e => e }) : void 0,
  we = '$lit$',
  ...
  ae = Array.isArray,
  Ne = e => ae(e) || typeof e?.[Symbol.iterator] == 'function',
  se = `[ 	
\f\r]`,
  H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  ge = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  Ue =
    e =>
    (t, ...s) => ({ _$litType$: e, strings: t, values: s }),
  a = Ue(1),
  D = Symbol.for('lit-noChange'),
  u = Symbol.for('lit-nothing'),
  xe = new WeakMap(),
  E = F.createTreeWalker(F, 129);
function _e(e, t) {
...
const He = (e, t) => {
  ...
  for (let c = 0; c < s; c++) {
    ...
    let h,
      ...
      p = -1,
      _ = 0;
    for (; _ < d.length && ((n.lastIndex = _), (f = n.exec(d)), f !== null); )
      ((_ = n.lastIndex),
        n === H
          ? f[1] === '!--'
            ? (n = ge)
            : f[1] !== void 0
              ? (n = fe)
              : f[2] !== void 0
                ? (Se.test(f[2]) && (o = RegExp('</' + f[2], 'g')), (n = A))
                : f[3] !== void 0 && (n = A)
          : n === A
            ? f[0] === '>'
              ? ((n = o ?? H), (p = -1))
              : f[1] === void 0
                ? (p = -2)
                : ((p = n.lastIndex - f[2].length),
                  (h = f[1]),
                  (n = f[3] === void 0 ? A : f[3] === '"' ? me : be))
            : n === me || n === be
              ? (n = A)
              : n === ge || n === fe
                ? (n = H)
                : ((n = A), (o = void 0)));
    const M = n === A && e[c + 1].startsWith('/>') ? ' ' : '';
    r +=
      n === H
        ? d + Oe
        : p >= 0
          ? (i.push(h), d.slice(0, p) + we + d.slice(p) + C + M)
          : d + C + (p === -2 ? c : M);
  }
  return [
    _e(
      e,
      r + (e[s] || '<?>') + (t === 2 ? '</svg>' : t === 3 ? '</math>' : '')
    ),
    i,
  ];
};
class q {
  constructor({ strings: t, _$litType$: s }, i) {
    ...
    for (; (o = E.nextNode()) !== null && d.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes())
          for (const p of o.getAttributeNames())
            if (p.endsWith(we)) {
              const _ = f[n++],
                M = o.getAttribute(p).split(C),
                Q = /([.?@])?(.*)/.exec(_);
              (d.push({
                type: 1,
                index: r,
              ...
              p.startsWith(C) &&
                (d.push({ type: 6, index: r }), o.removeAttribute(p));
        if (Se.test(o.tagName)) {
          const p = o.textContent.split(C),
            _ = p.length - 1;
          if (_ > 0) {
        ...
        if (o.data === $e) d.push({ type: 2, index: r });
        else {
          let p = -1;
          for (; (p = o.data.indexOf(C, p + 1)) !== -1; )
            (d.push({ type: 7, index: r }), (p += C.length - 1));
        }
      r++;
    }
  }
...
function O(e, t, s = e, i) {
  ...
  return (
    o?.constructor !== r &&
      (o?._$AO?.(!1),
      r === void 0 ? (o = void 0) : ((o = new r(e)), o._$AT(e, s, i)),
      i !== void 0 ? ((s._$Co ??= [])[i] = o) : (s._$Cl = o)),
    o !== void 0 && (t = O(e, o._$AS(e, t.values), o, i)),
    t
  );
}
class je {
  ...
  u(t) {
    const {
      ...
      o = (t?.creationScope ?? F).importNode(s, !0);
    E.currentNode = o;
    let r = E.nextNode(),
      n = 0,
      c = 0,
    ...
    for (; d !== void 0; ) {
      if (n === d.index) {
        let h;
        (d.type === 2
          ? (h = new W(r, r.nextSibling, this, t))
          : d.type === 1
            ? (h = new d.ctor(r, d.name, d.strings, this, t))
            : d.type === 6 && (h = new We(r, this, t)),
          this._$AV.push(h),
          (d = i[++c]));
      }
      n !== d?.index && ((r = E.nextNode()), n++);
    }
    return ((E.currentNode = F), o);
  }
  p(t) {
    let s = 0;
...
class W {
  ...
  _(t) {
    (this._$AH !== u && V(this._$AH)
      ? (this._$AA.nextSibling.data = t)
      : this.T(F.createTextNode(t)),
      (this._$AH = t));
  }
  $(t) {
    const { values: s, _$litType$: i } = t,
      o =
        typeof i == 'number'
          ? this._$AC(t)
          : (i.el === void 0 &&
              (i.el = q.createElement(_e(i.h, i.h[0]), this.options)),
            i);
    if (this._$AH?._$AD === o) this._$AH.p(s);
    else {
      const r = new je(o, this),
        n = r.u(this.options);
      (r.p(s), this.T(n), (this._$AH = r));
    }
  }
  _$AC(t) {
    let s = xe.get(t.strings);
    return (s === void 0 && xe.set(t.strings, (s = new q(t))), s);
  }
  k(t) {
    ...
    for (const r of t)
      (o === s.length
        ? s.push((i = new W(this.O(B()), this.O(B()), this, this.options)))
        : (i = s[o]),
        i._$AI(r),
        o++);
...
class ee {
  ...
  _$AI(t, s = this, i, o) {
    ...
    if (r === void 0)
      ((t = O(this, t, s, 0)),
        (n = !V(t) || (t !== this._$AH && t !== D)),
        n && (this._$AH = t));
    else {
      const c = t;
      let d, h;
      for (t = r[0], d = 0; d < r.length - 1; d++)
        ((h = O(this, c[i + d], s, d)),
          h === D && (h = this._$AH[d]),
          (n ||= !V(h) || h !== this._$AH[d]),
          h === u ? (t = u) : t !== u && (t += (h ?? '') + r[d + 1]),
          (this._$AH[d] = h));
    }
    n && !o && this.j(t);
  }
...
const Ge = ne.litHtmlPolyfillSupport;
(Ge?.(q, W), (ne.litHtmlVersions ??= []).push('3.3.1'));
const Ke = (e, t, s) => {
  const i = s?.renderBefore ?? t;
  let o = i._$litPart$;
  if (o === void 0) {
    const r = s?.renderBefore ?? null;
    i._$litPart$ = o = new W(t.insertBefore(B(), r), r, void 0, s ?? {});
  }
  return (o._$AI(e), o);
};
/**
...
class v extends R {
  ...
  update(t) {
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = Ke(s, this.renderRoot, this.renderOptions)));
  }
  connectedCallback() {
...
((v._$litElement$ = !0),
  (v.finalized = !0),
  le.litElementHydrateSupport?.({ LitElement: v }));
const Qe = le.litElementPolyfillSupport;
Qe?.({ LitElement: v });
(le.litElementVersions ??= []).push('4.2.1');
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */ const Ye = {
  ...
  Ze = (e = Ye, t, s) => {
    ...
    if (
      ...
      i === 'setter' && ((e = Object.create(e)).wrapped = !0),
      r.set(s.name, e),
      i === 'accessor')
    ) {
      const { name: n } = s;
    ...
    typeof s == 'object'
      ...
      : ((i, o, r) => {
          ...
          return (
            ...
            n ? Object.getOwnPropertyDescriptor(o, r) : void 0
          );
        })(e, t, s);
}
/**
...
var Je = Object.defineProperty,
  ...
  G = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? Xe(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
...
let L = class extends v {
  ...
  handleTokenInput(e) {
    const t = e.target;
    ((this.token = t.value), (this.errorMessage = ''));
  }
  async handleSubmit(e) {
    if ((e.preventDefault(), !!this.token.trim())) {
      ...
      try {
        ...
        (console.error('Token verification error:', t),
          (this.errorMessage =
...
L.styles = T`
  ...
  `;
G([S({ type: String })], L.prototype, 'token', 2);
G([l()], L.prototype, 'isVerifying', 2);
G([l()], L.prototype, 'errorMessage', 2);
G([l()], L.prototype, 'isSuccess', 2);
L = G([P('pb-token-setup')], L);
var et = Object.defineProperty,
  tt = Object.getOwnPropertyDescriptor,
  y = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? tt(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
    return (i && o && et(t, s, o), o);
  };
let m = class extends v {
  ...
  connectedCallback() {
    (super.connectedCallback(),
      ...
      this.defaultUrl && (this.body = this.defaultUrl));
  }
  determinePushType(e, t) {
    if (t) return 'file';
    const s = e.trim();
    if (!s) return 'note';
    const i = /https?:\/\/[^\s]+/g,
      o = s.match(i);
    return o?.length === 1 && s === o[0] ? 'link' : 'note';
  }
  async loadSendTargets() {
    try {
      const [e, t] = await Promise.all([
        ...
        s = e.ok ? e.devices : [],
        i = t.success ? t.ownedChannels : [];
      (console.log('Loaded devices:', s.length, 'channels:', i.length),
        (this.sendTargets = [
          ...s.map(o => ({
            id: o.iden,
            name: o.nickname,
            type: 'device',
            icon: this.getDeviceIcon(o.type),
          })),
          ...i.map(o => ({
            id: o.tag,
            name: o.name,
      ...
      console.error('Failed to load send targets:', e);
    }
  }
  getDeviceIcon(e) {
    switch (e) {
  ...
  handleInputChange(e) {
    const t = e.target,
      s = t.name;
    s === 'title'
      ? (this.pushTitle = t.value)
      : s === 'body' && (this.body = t.value);
  }
  clearMessages() {
    ((this.errorMessage = ''),
      (this.successMessage = ''),
      this.messageTimeout &&
        (clearTimeout(this.messageTimeout), (this.messageTimeout = null)));
  }
  setMessageWithTimeout(e, t = !1) {
    (console.log('Setting message:', e, 'isError:', t),
      this.messageTimeout && clearTimeout(this.messageTimeout),
      t
        ? ((this.errorMessage = e), (this.successMessage = ''))
        : ((this.successMessage = e), (this.errorMessage = '')),
      console.log(
      ...
      (this.messageTimeout = window.setTimeout(() => {
        (console.log('Clearing message after timeout'), this.clearMessages());
      }, 1e4)));
  }
  validateForm() {
    return !this.pushTitle.trim() && !this.body.trim() && !this.selectedFile
  ...
  async handleSend() {
    if (this.validateForm()) {
      ((this.isSending = !0), this.clearMessages());
      try {
        const e = this.determinePushType(
            this.body,
            this.selectedFile || void 0
          ),
          t = this.sendTargets.find(o => o.id === this.sendTo);
        if (!t && this.sendTo !== 'all') {
          (this.setMessageWithTimeout('Please select a valid send target', !0),
            (this.isSending = !1));
          return;
        }
        let s = {
          type: e,
          title: this.pushTitle.trim() || void 0,
          body: this.body.trim() || void 0,
        };
        if (
          (e === 'link' && (s.url = this.body.trim()),
          t?.type === 'channel'
            ? (s.channel_tag = t.id)
            : this.sendTo !== 'all' && (s.targetDeviceIden = t?.id),
          this.selectedFile && e === 'file')
        ) {
          const o = await this.selectedFile.arrayBuffer(),
            r = {
              name: this.selectedFile.name,
              type: this.selectedFile.type,
              size: this.selectedFile.size,
              lastModified: this.selectedFile.lastModified,
              buffer: Array.from(new Uint8Array(o)),
            },
            n = await chrome.runtime.sendMessage({
              cmd: 'UPLOAD_FILE',
              payload: {
                fileData: r,
                targetDeviceIden: t?.type === 'device' ? t.id : void 0,
                title: this.pushTitle.trim() || void 0,
                body: this.body.trim() || void 0,
                channel_tag: t?.type === 'channel' ? t.id : void 0,
              },
            });
          (n.success
            ? (this.setMessageWithTimeout('File sent successfully!'),
              this.resetForm())
            : this.setMessageWithTimeout(n.error || 'Failed to send file', !0),
            (this.isSending = !1));
          return;
        }
        ...
        i.ok
          ? (this.setMessageWithTimeout('Push sent successfully!'),
            this.resetForm())
          : this.setMessageWithTimeout(i.error || 'Failed to send push', !0);
      } catch (e) {
  ...
  resetForm() {
    ((this.pushTitle = ''), (this.body = ''), (this.selectedFile = null));
...
m.styles = T`
  ...
  `;
y([S({ type: String })], m.prototype, 'defaultUrl', 2);
y([l()], m.prototype, 'pushTitle', 2);
y([l()], m.prototype, 'body', 2);
y([l()], m.prototype, 'sendTo', 2);
y([l()], m.prototype, 'sendTargets', 2);
y([l()], m.prototype, 'selectedFile', 2);
y([l()], m.prototype, 'isLoading', 2);
y([l()], m.prototype, 'isSending', 2);
y([l()], m.prototype, 'errorMessage', 2);
y([l()], m.prototype, 'successMessage', 2);
y([l()], m.prototype, 'messageTimeout', 2);
m = y([P('pb-composer')], m);
var st = Object.defineProperty,
  it = Object.getOwnPropertyDescriptor,
  k = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? it(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
    return (i && o && st(t, s, o), o);
  };
let w = class extends v {
  ...
  async loadStoredState() {
    try {
      const e = await chrome.storage.local.get('pb_recent_pushes_state');
      if (e.pb_recent_pushes_state) {
        const t = e.pb_recent_pushes_state;
        ((this.pushes = t.pushes || []),
          (this.cursor = t.cursor),
          (this.hasMore = t.hasMore || !1),
          (this.lastModified = t.lastModified),
          (this.activeSubtab = t.activeSubtab || 'devices'),
  ...
  async saveState() {
    try {
      ...
      await chrome.storage.local.set({ pb_recent_pushes_state: e });
    } catch (e) {
  ...
  async loadDevices() {
    try {
      ...
      const t = await chrome.storage.local.get('pb_device_iden');
      ((this.currentDeviceIden = t.pb_device_iden),
        console.log(
  ...
  async loadPushes(e = !1) {
    if (
      (console.log('🔄 [RecentPushes] loadPushes called with refresh:', e),
      this.isLoading)
    ) {
    ...
    (console.log('🔄 [RecentPushes] Setting isLoading to true'),
      ...
      (this.errorMessage = ''));
    try {
      const t = e ? void 0 : this.lastModified;
      console.log('📋 [RecentPushes] Request params:', {
        refresh: e,
        lastModified: t,
        cursor: e ? 'undefined' : this.cursor,
      ...
      const s = await chrome.runtime.sendMessage({
        ...
        limit: 100,
        modifiedAfter: t,
        cursor: e ? void 0 : this.cursor,
        trigger: { type: 'popup_open', timestamp: Date.now() },
      });
      if (
        (console.log('📡 [RecentPushes] Response received:', {
          ok: s.ok,
          error: s.error,
          pushesCount: s.history?.pushes?.length || 0,
          hasCursor: !!s.history?.cursor,
        }),
        s.ok)
      ) {
        if (e)
          (console.log('🔄 [RecentPushes] Refreshing pushes list'),
            (this.pushes = s.history.pushes));
        else {
          console.log(
            '➕ [RecentPushes] Appending pushes to existing list with deduplication'
          );
          const i = new Map(this.pushes.map(r => [r.iden, r])),
            o = s.history.pushes.filter(r => !i.has(r.iden));
          o.length > 0
            ? (console.log(
                `➕ [RecentPushes] Adding ${o.length} new pushes (filtered out ${s.history.pushes.length - o.length} duplicates)`
              ),
              (this.pushes = [...this.pushes, ...o]))
            : console.log(
                'ℹ️ [RecentPushes] No new pushes to add (all were duplicates)'
              );
        }
        if (
          (this.pushes.sort((i, o) => o.created - i.created),
          (this.cursor = s.history.cursor),
          (this.hasMore = !!s.history.cursor),
          s.history.pushes.length > 0)
        ) {
          const i = Math.max(...s.history.pushes.map(o => o.modified));
          this.lastModified = i;
        }
        ...
        (console.error('❌ [RecentPushes] API returned error:', s.error),
          (this.errorMessage = s.error || 'Failed to load pushes'));
    } catch (t) {
      (console.error('❌ [RecentPushes] Exception occurred:', t),
  ...
  async handleDismiss(e) {
    try {
      (await chrome.runtime.sendMessage({ cmd: 'dismissPush', pushIden: e })).ok
        ? ((this.pushes = this.pushes.filter(s => s.iden !== e)),
          await this.saveState())
        : (this.errorMessage = 'Failed to dismiss push');
    } catch (t) {
      ((this.errorMessage = 'Failed to dismiss push'),
        console.error('Failed to dismiss push:', t));
    }
  }
  async handleDelete(e) {
    try {
      const t = this.pushes.find(i => i.iden === e);
      if (!t) {
        this.errorMessage = 'Push not found';
        return;
      }
      if (!this.isPushOwnedByCurrentDevice(t)) {
        this.errorMessage = 'Cannot delete - you do not own this push';
        return;
      }
      (await chrome.runtime.sendMessage({ cmd: 'deletePush', pushIden: e })).ok
        ? ((this.pushes = this.pushes.filter(i => i.iden !== e)),
          await this.saveState())
        : (this.errorMessage = 'Failed to delete push');
    } catch (t) {
      ((this.errorMessage = 'Failed to delete push'),
        console.error('Failed to delete push:', t));
    }
  }
  handleRefresh() {
    this.loadPushes(!0);
  ...
  handleSubtabChange(e) {
    ((this.activeSubtab = e), this.saveState());
  }
  handleMessage(e) {
    (e.cmd === 'syncHistory' &&
      (e.source === 'tickle' || e.source === 'background') &&
      (console.log('🔄 [RecentPushes] Received sync message:', e),
      this.loadPushes(!0)),
      e.cmd === 'pushCreated' &&
        (console.log(
  ...
  getFilteredPushes() {
    return this.activeSubtab === 'channels'
      ? this.pushes.filter(e => e.channel_iden && !e.receiver_iden)
      : this.pushes.filter(e => !e.channel_iden);
  }
  getDeviceName(e) {
    const t = this.devices.find(s => s.iden === e);
    return t ? t.nickname : 'Unknown Device';
  }
  getDeviceType(e) {
    const t = this.devices.find(s => s.iden === e);
  ...
  getEmptyStateSubMessage() {
    return this.activeSubtab === 'channels'
      ...
      : 'Send your first push to get started!';
  }
  isPushOwnedByCurrentDevice(e) {
    return e.metadata?.is_owned_by_user || !1;
  }
  getDeviceIcon(e) {
    switch (e) {
      case 'android':
  ...
  getFileIcon(e, t) {
    ...
    return s.startsWith('image/') ||
      /\.(jpg|jpeg|png|gif|bmp|webp|svg)$/.test(i)
      ? '🖼️'
      : s.startsWith('video/') || /\.(mp4|avi|mov|wmv|flv|webm|mkv)$/.test(i)
        ? '🎥'
        : s.startsWith('audio/') || /\.(mp3|wav|flac|aac|ogg|m4a)$/.test(i)
          ? '🎵'
          : s.includes('pdf') || i.endsWith('.pdf')
            ? '📄'
            : s.includes('word') || /\.(doc|docx)$/.test(i)
              ? '📝'
              : s.includes('excel') ||
                  /\.(xls|xlsx)$/.test(i) ||
                  ...
                  /\.(ppt|pptx)$/.test(i)
                ? '📊'
                : /\.(zip|rar|7z|tar|gz)$/.test(i)
                  ? '📦'
                  : /\.(js|ts|html|css|json|xml|py|java|cpp|c|h)$/.test(i)
                    ? '💻'
                    : '📎';
  }
  isImageFile(e) {
    if (e.image_url) return !0;
    if (!e.file_type && !e.file_name) return !1;
    const t = e.file_type?.toLowerCase() || '',
      s = e.file_name?.toLowerCase() || '';
    return t.startsWith('image/') || /\.(jpg|jpeg|png|gif|bmp|webp)$/.test(s);
  }
  ...
  renderFileDisplay(e) {
    return e.type !== 'file'
      ...
      <div class="file-display">
        ${
          this.isImageFile(e) && e.image_url
            ? a`
              <div
                class="file-preview"
  ...
  render() {
    const e = this.getFilteredPushes();
    return a`
              ...
              <div class="push-item">
                <div class="push-header">
                  ...
                  <div class="push-actions">
                    ...
                    ${
                      this.isPushOwnedByCurrentDevice(t)
                        ? a`
                    <button
                ...
                <div class="device-info">
                  ...
                  >
                  ${t.metadata?.ownership_reason ? a`<span class="ownership-info">• ${t.metadata.ownership_reason}</span>` : ''}
                </div>
              </div>
            `
          )}
...
w.styles = T`
  ...
  `;
k([l()], w.prototype, 'pushes', 2);
k([l()], w.prototype, 'isLoading', 2);
k([l()], w.prototype, 'errorMessage', 2);
k([l()], w.prototype, 'hasMore', 2);
k([l()], w.prototype, 'cursor', 2);
k([l()], w.prototype, 'activeSubtab', 2);
k([l()], w.prototype, 'devices', 2);
k([l()], w.prototype, 'lastModified', 2);
w = k([P('pb-recent-pushes')], w);
var ot = Object.defineProperty,
  rt = Object.getOwnPropertyDescriptor,
  te = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? rt(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
    return (i && o && ot(t, s, o), o);
  };
let N = class extends v {
  ...
  connectedCallback() {
    (super.connectedCallback(), this.loadMirrors());
  }
  async loadMirrors() {
    ((this.loading = !0), (this.error = null));
    try {
      console.log('🔍 [MirrorList] Loading active mirrors');
      const e = await chrome.runtime.sendMessage({ cmd: 'getActiveMirrors' });
      e.success
        ? ((this.mirrors = e.mirrors || []),
          console.log('🔍 [MirrorList] Loaded mirrors:', {
            count: this.mirrors.length,
            mirrors: this.mirrors.map(t => ({
              id: t.id,
              app: t.meta.application_name,
              title: t.meta.title,
            })),
          }))
        : ((this.error = e.error || 'Failed to load notifications'),
          console.error('🔍 [MirrorList] Failed to load mirrors:', e.error));
    } catch (e) {
      (console.error('🔍 [MirrorList] Failed to load mirrors:', e),
        (this.error = 'Failed to load notifications'));
    } finally {
      this.loading = !1;
    }
  }
  async handleMirrorClick(e) {
    try {
      (console.log('👆 [MirrorList] Mirror clicked:', {
        id: e.id,
        app: e.meta.application_name,
        title: e.meta.title,
      }),
        await chrome.notifications.update(e.id, { priority: 2 }),
        setTimeout(() => {
          chrome.notifications.update(e.id, { priority: 0 });
        }, 2e3));
    } catch (t) {
      console.error('👆 [MirrorList] Failed to focus notification:', t);
    }
  }
  render() {
    return this.loading
...
N.styles = T`
  ...
  `;
te([S({ type: Boolean })], N.prototype, 'loading', 2);
te([l()], N.prototype, 'mirrors', 2);
te([l()], N.prototype, 'error', 2);
N = te([P('pb-mirror-list')], N);
var nt = Object.defineProperty,
  at = Object.getOwnPropertyDescriptor,
  K = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? at(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
    return (i && o && nt(t, s, o), o);
  };
let I = class extends v {
  ...
  getZoneClasses() {
    const e = [];
    return (
      this.dragOver && e.push('drag-over'),
      this.uploadState.error && e.push('error'),
      this.uploadState.uploading && e.push('uploading'),
      e.join(' ')
    );
  }
  handleZoneClick(e) {
  ...
  handleDrop(e) {
    ...
    t && t.length > 0 && this.setFile(t[0]);
  }
  setFile(e) {
    ((this.uploadState = { file: e, uploading: !1, progress: 0, error: null }),
      this.isFileValid(e) ||
        (this.uploadState.error = `File size (${this.formatFileSize(e.size)}) exceeds the 25MB limit`));
  }
  isFileValid(e) {
  ...
  async handleUpload() {
    if (!(!this.uploadState.file || !this.isFileValid(this.uploadState.file))) {
      ((this.uploadState.uploading = !0),
        (this.uploadState.progress = 0),
        (this.uploadState.error = null));
      try {
        const e = await this.uploadState.file.arrayBuffer(),
          t = {
            ...
            buffer: Array.from(new Uint8Array(e)),
          },
        ...
        s.success
          ...
          : ((this.uploadState.error = s.error || 'Upload failed'),
            (this.uploadState.uploading = !1));
      } catch (e) {
  ...
  handleCancel() {
    this.uploadState = { file: null, uploading: !1, progress: 0, error: null };
    const e = this.shadowRoot?.querySelector('.file-input');
    e && (e.value = '');
  }
  updateProgress(e) {
    this.uploadState.uploading && (this.uploadState.progress = e);
  }
  setError(e) {
    ((this.uploadState.error = e), (this.uploadState.uploading = !1));
  }
};
I.styles = T`
    :host {
  ...
  `;
K([S({ type: String })], I.prototype, 'targetDeviceIden', 2);
K([l()], I.prototype, 'dragOver', 2);
K([l()], I.prototype, 'uploadState', 2);
K([l()], I.prototype, 'maxFileSize', 2);
I = K([P('pb-file-drop')], I);
var lt = Object.defineProperty,
  dt = Object.getOwnPropertyDescriptor,
  b = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? dt(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
...
let g = class extends v {
  constructor() {
    (super(...arguments),
      ...
      (this.isLoadingOlder = !1),
      (this.hasMoreMessages = !0),
      (this.messageCursor = null),
      (this.conversationNotFound = !1),
      (this.isReloading = !1));
  }
  get smsCursorStorageKey() {
  ...
  updated(e) {
    (e.has('conversationId') &&
      this.conversationId &&
      (this.loadThread(), this.initializeRecipients()),
      e.has('thread') && this.thread && this.scrollToBottom());
  }
  initializeRecipients() {
    if (this.conversationId && this.isGroupConversation) {
      const e = this.conversationId.split(',').map(t => t.trim());
      this.recipients = e.map(t => ({ number: t, name: t }));
    } else
      this.conversationId && !this.isGroupConversation
        ? (this.recipients = [
            { number: this.conversationId, name: this.conversationId },
          ])
        : (this.recipients = []);
  }
  async loadThread() {
    ...
    try {
      ...
      let e = this.deviceIden;
      if (e) console.log('💬 [SmsThread] Using provided device ID:', e);
      else {
        console.log(
        ...
        try {
          ...
          if (
            (console.log('💬 [SmsThread] GET_DEFAULT_SMS_DEVICE response:', s),
            s.success && s.device)
          )
            ((e = s.device.iden),
              console.log('💬 [SmsThread] Got default SMS device:', e));
          else
            throw (
              console.error(
              ...
              new Error(s.error || 'No SMS device available')
            );
        } catch (s) {
          throw (
            console.error(
            ...
            new Error('No SMS device available')
          );
        }
      }
      ((this.deviceIden = e), await this.loadStoredCursor());
      const t = await chrome.runtime.sendMessage({
      ...
      if (t.success) {
        ((this.thread = t.thread),
          (this.messageCursor = t.cursor || null),
          (this.hasMoreMessages = t.hasMore || !1),
        ...
        try {
          ...
          console.error('💬 [SmsThread] Failed to clear SMS notifications:', s);
        }
        (this.scrollToBottom(),
      ...
      console.error('💬 [SmsThread] Failed to load thread from API:', e);
    } finally {
      this.isLoading = !1;
    }
  }
  async loadOlderMessages() {
    if (
      !(!this.conversationId || this.isLoadingOlder || !this.hasMoreMessages)
    ) {
      this.isLoadingOlder = !0;
      try {
        ...
        if (e.success && this.thread) {
          const t = e.messages || [];
          ((this.thread = {
            ...this.thread,
            messages: [...t, ...this.thread.messages],
          }),
            (this.messageCursor = e.cursor || null),
            (this.hasMoreMessages = e.hasMore || !1),
            await this.saveStoredCursor());
        }
      } catch (e) {
  ...
  scrollToBottom() {
    (console.log('🔄 [SmsThread] scrollToBottom called'),
      this.updateComplete.then(() => {
        const e = this.shadowRoot?.querySelector('.messages-container');
        if ((console.log('🔄 [SmsThread] Container found:', !!e), e)) {
          const t = e;
          ...
          const s = e.querySelectorAll('img'),
            i = Array.from(s).map(o =>
              o.complete
                ? Promise.resolve()
                : new Promise(r => {
                    ((o.onload = r), (o.onerror = r));
                  })
            );
          Promise.all(i).then(() => {
            ...
            requestAnimationFrame(() => {
              ...
              ((t.scrollTop = o),
                setTimeout(() => {
                  ...
                  Math.abs(r - n) > 5
                    ? (console.log(
                        `🔄 [SmsThread] Final scroll adjustment - current: ${r}, target: ${n}`
                      ),
                      (t.scrollTop = n))
                    : console.log(
                        '🔄 [SmsThread] Successfully scrolled to bottom'
                      );
                }, 100));
            });
          });
  ...
  handleScrollTop() {
    const e = this.shadowRoot?.querySelector('.messages-container');
    e && e.scrollTop === 0 && this.hasMoreMessages && this.loadOlderMessages();
  }
  async loadStoredCursor() {
    try {
      const e = await chrome.storage.local.get(this.smsCursorStorageKey);
      e[this.smsCursorStorageKey] &&
        ((this.messageCursor = e[this.smsCursorStorageKey]),
        console.log(
          `📱 [SMS Thread] Loaded stored cursor for ${this.conversationId}:`,
          this.messageCursor
        ));
    } catch (e) {
      console.error('Failed to load stored SMS cursor:', e);
    }
  }
  async saveStoredCursor() {
    try {
      ...
      console.error('Failed to save SMS cursor:', e);
    }
  }
  handleInputChange(e) {
    const t = e.target;
    ((this.messageText = t.value),
      (t.style.height = 'auto'),
  ...
  handleRecipientInputChange(e) {
    const t = e.target;
    this.newRecipientNumber = t.value;
  }
  handleRecipientInputKeyDown(e) {
    e.key === 'Enter' && (e.preventDefault(), this.addRecipient());
  }
  addRecipient() {
    const e = this.newRecipientNumber.trim();
    if (e && /^\+?[\d\s\-()]+$/.test(e)) {
      if (this.recipients.some(t => t.number === e)) {
        this.newRecipientNumber = '';
        return;
      }
      ((this.recipients = [...this.recipients, { number: e, name: e }]),
        (this.newRecipientNumber = ''),
        this.updateGroupConversationId());
    }
  }
  removeRecipient(e) {
    ((this.recipients = this.recipients.filter(t => t.number !== e)),
      this.updateGroupConversationId());
  }
  updateGroupConversationId() {
    this.recipients.length > 1
      ? ((this.conversationId = this.recipients.map(e => e.number).join(',')),
        (this.isGroupConversation = !0))
      : this.recipients.length === 1
        ? ((this.conversationId = this.recipients[0].number),
          (this.isGroupConversation = !1))
        : ((this.conversationId = ''), (this.isGroupConversation = !1));
  }
  handleFileSelect(e) {
    const s = e.target.files?.[0];
    if (s) {
  ...
  formatFileSize(e) {
    ...
    const t = 1024,
      s = ['Bytes', 'KB', 'MB'],
      i = Math.floor(Math.log(e) / Math.log(t));
    return parseFloat((e / Math.pow(t, i)).toFixed(1)) + ' ' + s[i];
  }
  async sendMessage() {
    if (
    ...
    try {
      ...
      if (this.selectedFile) {
        const s = await this.selectedFile.arrayBuffer(),
          i = {
            name: this.selectedFile.name,
            type: this.selectedFile.type,
            size: this.selectedFile.size,
            lastModified: this.selectedFile.lastModified,
            buffer: Array.from(new Uint8Array(s)),
          },
          o = await chrome.runtime.sendMessage({
            cmd: 'UPLOAD_FILE_FOR_SMS',
            payload: { fileData: i, targetDeviceIden: this.deviceIden },
          });
        if (!o.success) {
          console.error('Failed to upload file:', o.error);
          return;
        }
        e = [
          {
      ...
      t.success
        ...
        : (console.error('Failed to send SMS:', t.error),
          t.error &&
            t.error.includes('CONVERSATION_NOT_FOUND:') &&
            ((this.conversationNotFound = !0),
            console.log(
    ...
    if (!(!this.conversationId || !this.deviceIden || this.isReloading)) {
      ...
      try {
        ...
        e.success && e.thread
          ...
          : console.error('💬 [SmsThread] Failed to reload thread:', e.error);
      } catch (e) {
        console.error('💬 [SmsThread] Error reloading thread:', e);
      } finally {
        this.isReloading = !1;
      }
    }
    ...
    return this.isLoading
      ...
      : this.thread
        ...
        <div class="error-state">
          ...
          >
            ${this.isReloading ? a`<div class="spinner-small"></div> Reloading...` : 'Reload Conversation'}
          </button>
        </div>
      `
          : a`
...
g.styles = T`
  ...
  `;
b([S({ type: String })], g.prototype, 'conversationId', 2);
b([S({ type: String })], g.prototype, 'deviceIden', 2);
b([S({ type: Boolean })], g.prototype, 'isGroupConversation', 2);
b([l()], g.prototype, 'thread', 2);
b([l()], g.prototype, 'messageText', 2);
b([l()], g.prototype, 'isLoading', 2);
b([l()], g.prototype, 'isSending', 2);
b([l()], g.prototype, 'selectedFile', 2);
b([l()], g.prototype, 'recipients', 2);
b([l()], g.prototype, 'newRecipientNumber', 2);
b([l()], g.prototype, 'isLoadingOlder', 2);
b([l()], g.prototype, 'hasMoreMessages', 2);
b([l()], g.prototype, 'messageCursor', 2);
b([l()], g.prototype, 'conversationNotFound', 2);
b([l()], g.prototype, 'isReloading', 2);
g = b([P('pb-sms-thread')], g);
var ct = Object.defineProperty,
  pt = Object.getOwnPropertyDescriptor,
  U = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? pt(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
    return (i && o && ct(t, s, o), o);
  };
let z = class extends v {
  ...
  connectedCallback() {
    (super.connectedCallback(), this.loadConversations());
  }
  async loadConversations() {
    ...
    try {
      ...
      if (
        (console.log('[ConversationList] Received response:', e),
        console.log('[ConversationList] Response type:', typeof e),
        console.log('[ConversationList] Response success:', e?.success),
        !e)
      ) {
      ...
      if (e.success)
        (console.log(
          `[ConversationList] Successfully loaded ${e.conversations?.length || 0} conversations from API`
        ),
          (this.conversations = e.conversations || []),
          this.filterConversations());
      else {
        const t = e.error || 'Unknown error occurred';
        (console.error(
          '[ConversationList] Failed to load conversations from API:',
          t
        ),
          console.error('[ConversationList] Full error response:', e),
          (this.conversations = []),
          this.filterConversations());
      }
    } catch (e) {
  ...
  handleSearchInput(e) {
    const t = e.target;
    ((this.searchQuery = t.value), this.filterConversations());
  }
  selectConversation(e) {
    this.selectedConversationId = e;
    const t = this.conversations.find(i => i.id === e),
      s = t?.name || t?.recipients?.map(i => i.name).join(', ') || 'Unknown';
    (this.dispatchEvent(
      new CustomEvent('conversation-selected', {
        detail: { conversationId: e, conversationName: s },
        bubbles: !0,
        composed: !0,
      })
    ),
...
z.styles = T`
  ...
  `;
U([S({ type: String })], z.prototype, 'selectedConversationId', 2);
U([l()], z.prototype, 'conversations', 2);
U([l()], z.prototype, 'searchQuery', 2);
U([l()], z.prototype, 'isLoading', 2);
U([l()], z.prototype, 'filteredConversations', 2);
z = U([P('pb-conversation-list')], z);
var ht = Object.defineProperty,
  ut = Object.getOwnPropertyDescriptor,
  $ = (e, t, s, i) => {
    for (
      var o = i > 1 ? void 0 : i ? ut(t, s) : t, r = e.length - 1, n;
      r >= 0;
      r--
    )
      (n = e[r]) && (o = (i ? n(t, s, o) : n(o)) || o);
...
let x = class extends v {
  constructor() {
    (super(...arguments),
      ...
      (this.isLoadingPosts = !1),
      (this.searchTimeout = null));
  }
  connectedCallback() {
    (super.connectedCallback(), this.loadSubscriptions());
  }
  async loadSubscriptions() {
    try {
      ...
      e.success
        ...
        : (this.errorMessage = e.error || 'Failed to load subscriptions');
    } catch (e) {
  ...
  onSearchInput(e) {
    const t = e.target;
    if (
      ((this.searchQuery = t.value.trim()),
      this.searchTimeout && clearTimeout(this.searchTimeout),
      !this.searchQuery)
    ) {
      ((this.searchResults = []), (this.isSearching = !1));
      return;
    }
  ...
  async searchChannels() {
    if (this.searchQuery)
      try {
        ((this.isSearching = !0), (this.errorMessage = ''));
        const e = await chrome.runtime.sendMessage({
          cmd: 'GET_CHANNEL_INFO',
          channelTag: this.searchQuery,
        });
        e.success
          ? (this.searchResults = [e.channelInfo])
          : e.error === 'Channel not found'
            ? (this.searchResults = [])
            : ((this.errorMessage = e.error || 'Failed to search channels'),
              (this.searchResults = []));
      } catch (e) {
  ...
  async subscribeToChannel(e) {
    try {
      ...
      t.success
        ? ((this.successMessage = `Successfully subscribed to ${e}`),
          await this.loadSubscriptions(),
          (this.searchResults = []),
          (this.searchQuery = ''))
        : (this.errorMessage = t.error || 'Failed to subscribe to channel');
    } catch (t) {
      ((this.errorMessage = 'Failed to subscribe to channel'),
        console.error('Failed to subscribe to channel:', t));
    }
  }
  async unsubscribeFromChannel(e) {
    try {
      ((this.errorMessage = ''), (this.successMessage = ''));
      const t = await chrome.runtime.sendMessage({
      ...
      t.success
        ? ((this.successMessage = 'Successfully unsubscribed from channel'),
          await this.loadSubscriptions())
        : (this.errorMessage = t.error || 'Failed to unsubscribe from channel');
    } catch (t) {
      ((this.errorMessage = 'Failed to unsubscribe from channel'),
        console.error('Failed to unsubscribe from channel:', t));
    }
  }
  isSubscribedToChannel(e) {
    return this.subscriptions.some(t => t.channel?.tag === e && t.active);
  }
  handleSubtabChange(e) {
    ((this.activeSubtab = e), e === 'recent' && this.loadSubscriptionPosts());
  }
  async loadSubscriptionPosts() {
    try {
      ((this.isLoadingPosts = !0), (this.errorMessage = ''));
      const e = await chrome.runtime.sendMessage({
        cmd: 'GET_SUBSCRIPTION_POSTS',
      });
      e.success
        ? (this.subscriptionPosts = e.posts)
        : (this.errorMessage = e.error || 'Failed to load subscription posts');
    } catch (e) {
      ((this.errorMessage = 'Failed to load subscription posts'),
        console.error('Failed to load subscription posts:', e));
    } finally {
      this.isLoadingPosts = !1;
    }
  }
  async refreshSubscriptions() {
    try {
      ...
      e.success
        ...
        : (this.errorMessage = e.error || 'Failed to refresh subscriptions');
    } catch (e) {
  ...
  renderChannelIcon(e) {
    return e
      ...
      : a`<div class="channel-icon">?</div>`;
  }
  renderSearchResults() {
    return this.isSearching
      ? a`<div class="loading">Searching...</div>`
      : this.searchResults.length === 0 && this.searchQuery
        ? a`<div class="empty-state">
        No channels found for "${this.searchQuery}"
      </div>`
        : a`
      <div class="search-results">
        ${this.searchResults.map(e => {
          const t = this.isSubscribedToChannel(e?.tag || '');
          return a`
            <div class="channel-card">
              ${this.renderChannelIcon(e)}
              <div class="channel-info">
                <div class="channel-name">${e?.name || 'Unknown Channel'}</div>
                <div class="channel-description">${e?.description || 'No description available'}</div>
                <div class="channel-tag">@${e?.tag || 'unknown'}</div>
              </div>
              ${
                t
                  ? a`<div class="subscribed-badge">Subscribed</div>`
                  : a`<button
  ...
  renderSubscriptions() {
    return this.isLoading
      ? a`<div class="loading">Loading subscriptions...</div>`
      : this.subscriptions.length === 0
        ? a`<div class="empty-state">No channel subscriptions yet</div>`
        : a`
        ...
        ${this.subscriptions.map(
          e => a`
            <div class="subscription-item">
              ...
              <div class="channel-info">
                <div class="channel-name">${e.channel?.name || 'Unknown Channel'}</div>
                <div class="channel-description">
                  ${e.channel?.description || 'No description available'}
                </div>
                <div class="channel-tag">@${e.channel?.tag || 'unknown'}</div>
              </div>
              <button
...
x.styles = T`
  ...
  `;
$([S({ type: Array })], x.prototype, 'subscriptions', 2);
$([l()], x.prototype, 'searchQuery', 2);
$([l()], x.prototype, 'searchResults', 2);
$([l()], x.prototype, 'isLoading', 2);
$([l()], x.prototype, 'isSearching', 2);
$([l()], x.prototype, 'errorMessage', 2);
$([l()], x.prototype, 'successMessage', 2);
$([l()], x.prototype, 'activeSubtab', 2);
$([l()], x.prototype, 'subscriptionPosts', 2);
$([l()], x.prototype, 'isLoadingPosts', 2);
x = $([P('pb-channels')], x);
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    console.error('🪟 [Popup] Failed to send POPUP_OPEN message:', t);
  }
  ...
  try {
    if (!(await Me('pb_token')))
      e.innerHTML = '<pb-token-setup></pb-token-setup>';
    else {
      const s = await Ce(),
        i = s ? await ve() : null;
      ((e.innerHTML = `
    ...
    (console.error('Failed to initialize popup:', t),
      (e.innerHTML = `
...
function gt() {
  const e = document.querySelectorAll('.tab-button'),
    t = document.querySelectorAll('.tab-pane');
  e.forEach(s => {
      ...
      (e.forEach(o => o.classList.remove('active')),
        ...
        t.forEach(o => {
          (o.classList.remove('active'),
            o.getAttribute('data-tab') === i && o.classList.add('active'));
        }));
    });
  });
}
async function ft() {
  try {
    const e = await ve();
    if (e) {
      const c = e.nickname || e.model || `Device ${e.iden.slice(0, 8)}`,
        d = document.querySelector('[data-tab="messages"]');
      d &&
        (d.innerHTML = `
    ...
    const t = document.getElementById('conversation-list'),
      s = document.getElementById('sms-thread'),
      i = document.getElementById('sms-back-button'),
      o = document.getElementById('conversation-title'),
      r = document.querySelector('.conversation-list-view'),
      n = document.querySelector('.sms-thread-view');
    t &&
      s &&
      i &&
      o &&
      r &&
      n &&
      (t.addEventListener('conversation-selected', c => {
        const { conversationId: d, conversationName: h } = c.detail;
        ((s.conversationId = d),
          (o.textContent = h || 'Conversation'),
          r.classList.remove('active'),
          n.classList.add('active'),
          setTimeout(() => {
            s.scrollToBottom && s.scrollToBottom();
          }, 300));
      }),
      i.addEventListener('click', () => {
        (n.classList.remove('active'),
          r.classList.add('active'),
          (t.selectedConversationId = ''));
      }));
  } catch (e) {
    console.error('Failed to setup SMS interface:', e);
  }
}
function bt() {
  const e = document.getElementById('about-button');
  e &&
...
function mt() {
  ...
  const t = e.querySelector('#close-about');
  (t &&
    t.addEventListener('click', () => {
      document.body.removeChild(e);
    }),
    e.addEventListener('click', s => {
      s.target === e && document.body.removeChild(e);
    }));
}
